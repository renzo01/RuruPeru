...
public class MySQLConexion {
	...
	public static Connection getConexion(){
		...
		String url= "jdbc:mysql://localhost:3306/DB_RURUPERU";//variable String que contiene los datos del servidor
		String usr= "root";//variable String que contiene el dato del usuario
		String psw= "";//variable String que contiene el dato del password
